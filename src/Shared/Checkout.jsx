...
const Checkout = () => {
    ...
    const handleSubmit = (event) => {
       ...
       alert('Thank you for visiting! Your order is booked.')
       navigate(-1);
    }
        ...
        <>
            <div className="container my-5 checkoutall" >
                ...
                <div className="col-md-3">
                  ...
                  <input type="text" className="form-control" id="upiId" placeholder="Enter your UPI ID" required />
                  <div className="invalid-feedback">
              ...
              {['credit', 'debit'].includes(paymentMethod) && (
                <>
                  ...
                  <div className="col-md-6">
                                ...
                                <div className="col-md-6">
                                    <label htmlFor="cc-number" className="form-label">Name on Card </label>
              ...
              {paymentMethod==='paytm' && (
                 <div className="col-md-3">
                 <label htmlFor="upiId" className="form-label">Paytm ID</label>
                 <input type="text" className="form-control" id="upiId" placeholder="Enter your UPI ID" required />
                 <div className="invalid-feedback">
                    Please enter your Paytm ID.
                            ...
                            <button className="w-100 btn btn-primary btn-lg submit" type="submit" >Continue to checkout</button>
                        </form>
                    </div>
                </div>
            </div>
